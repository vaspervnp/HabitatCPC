...
# Ο κώδικας της τράπεζας 0 δεν επιτρέπεται να φτάσει εδώ: στο #3F80 ο φορτωτής
...
# σφάλμα build. Ηταν #3E00 ως το βήμα 26: το επίμετρο είναι σαράντα bytes και
# κρατούσε πεντακόσια δώδεκα (βλ. src/boot.asm).
ENDGAME = 0x3F80
