...
; ΜΕΤΑΛΛΟ 55 ΚΑΙ ΒΙΟΠΛΑΣΤΙΚΟ 30, ΟΧΙ 30 ΚΑΙ 10 (§10.1). Μια αποικία που ζει
; θέλει ΤΡΙΑ κτίσματα από τον κατάλογο του build.asm: ηλιακό (15+8) για το
; οξυγόνο της ημέρας, συλλέκτη (14+10) για τη νύχτα — ο ήλιος λείπει το 40%
; του sol (§6.10) — και αντλία (22+8) για το νερό. Σύνολο 51+26. Με τα 30+10
; του §10.1 ο παίκτης αγόραζε ΕΝΑ, και καμία μηχανή της αρχικής αποικίας δεν
; φτιάχνει μέταλλο: ό,τι κι αν διάλεγε, η αποικία πέθαινε ως το sol 5.
; Μετρημένο και τα τέσσερα σενάρια στο tools/balance.py. Μένουν 4+4: όχι
; τέταρτο κτίσμα, και η επόμενη ανάγκη — τροφή — θέλει ό,τι δεν υπάρχει ακόμη.
ng_start_stock:
        dw 60, 40, 0, 55, 30, 0, 4, 0, 0, 0, 0, 0, 0, 0
